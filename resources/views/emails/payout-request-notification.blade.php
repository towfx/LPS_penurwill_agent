                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    ...
                                                    <span style="color: #374151; font-size: 14px; margin-left: 10px;">{{ $payout->agent->name ?? '[AGENT_NAME]' }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <strong style="color: #162d25; font-size: 14px;">Amount Requested:</strong>
                                                    <span style="color: #374151; font-size: 14px; margin-left: 10px;">RM {{ isset($payout) ? number_format($payout->amount, 2) : '[PAYOUT_AMOUNT]' }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <strong style="color: #162d25; font-size: 14px;">Bank:</strong>
                                                    <span style="color: #374151; font-size: 14px; margin-left: 10px;">{{ $payout->bank_name ?? 'N/A' }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <strong style="color: #162d25; font-size: 14px;">Account No:</strong>
                                                    <span style="color: #374151; font-size: 14px; margin-left: 10px;">{{ $payout->bank_account_number ?? 'N/A' }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <div style="margin: 20px 0 0 0; color: #374151; font-size: 14px; line-height: 1.6;">
                                {!! $template->getFilled('body_action') !!}
                            </div>
                        </td>
                    </tr>
