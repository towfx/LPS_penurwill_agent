                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="{{ config('app.url') }}/agent/payouts" style="display: inline-block; background-color: #bc9c5f; color: #162d25; text-decoration: none; padding: 12px 24px; border-radius: 6px; font-weight: 600; font-size: 16px;">
