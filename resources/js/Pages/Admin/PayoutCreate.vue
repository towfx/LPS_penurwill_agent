<template>
  <div>
    ...
    <nav class="text-sm text-stone-500 mb-4">
      ...
      <span class="text-stone-900 font-medium">Create Payout</span>
    </nav>

    <!-- Title -->
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-2xl font-bold text-forest-dark">Create Payout</h1>
      ...
      <div class="bg-white rounded-lg shadow-sm border border-stone-200 p-6 mb-6">
        ...
        <div class="mb-6">
          ...
          <input
            ...
            :placeholder="formatCurrency('RM', approvedSummary.total_commission)"
            required
          />
